# -*- coding: utf-8 -*-
"""
Created on Sun Jan 22 23:42:52 2023
...
optim.set_target(target="Neutrophil")
optim.select_samples(method="outerquartile",ctrl="Ctrl",threshold=1.5,q=[0, 0.25, 0.5, 0.75, 1],ignore_ctrl=True)
optim.optim_base(base_sig_df=sig_df1,dec_names=[["Neutrophil"]],val_names=[["Neutrophil"]],do_plot=True)
optim.optim_loop(raw_ref=raw_ref,candi=['B','Basophil','CD4','CD8','Cholangiocyte','Eosinophil','Hepatocyte','Kupffer',
                 ...
                 target=["Neutrophil"],dec_names=[["Neutrophil"]],val_names=[["Neutrophil"]],do_plot=False)
cor_df = optim.cor_df
cor_df.to_csv('C:/github/LiverDeconv/_Figures_new/Figure_4/data/neu_fluctuate_quartile_comb2ref.csv')
pd.to_pickle(cor_df,'C:/github/LiverDeconv/_Figures_new/Figure_4/data/neu_fluctuate_quartile_comb2ref.pkl')

#%% 230209 add all combination
cor_df = pd.read_pickle('C:/github/LiverDeconv/_Figures_new/Figure_4/data/neu_fluctuate_quartile_comb2ref.pkl')
add_df = pd.DataFrame([0.452,('B','Basophil','CD4','CD8','Cholangiocyte','Eosinophil','Hepatocyte','Kupffer',
                                            'LSEC','Monocyte','NK','Neutrophil','Stellate')],index=cor_df.columns.tolist()).T
update_df = pd.concat([cor_df,add_df])
pd.to_pickle(update_df,'C:/github/LiverDeconv/_Figures_new/Figure_4/data/neu_fluctuate_quartile_comb2ref.pkl')
update_df.to_csv('C:/github/LiverDeconv/_Figures_new/Figure_4/data/neu_fluctuate_quartile_comb2ref.csv')
