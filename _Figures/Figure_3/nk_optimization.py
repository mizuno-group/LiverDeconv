# -*- coding: utf-8 -*-
"""
Created on Mon Jan 23 18:36:35 2023
...
optim.optim_loop(raw_ref=raw_ref,candi=['B','Basophil','CD4','CD8','Cholangiocyte','Eosinophil','Hepatocyte','Kupffer',
                 ...
                 target=["NK"],dec_names=[["NK"]],val_names=[["NK"]],do_plot=False)
cor_df = optim.cor_df
cor_df.to_csv('C:/github/LiverDeconv/_Figures_new/Figure_4/data/nk_fluctuate_quartile_comb2ref.csv')
pd.to_pickle(cor_df,'C:/github/LiverDeconv/_Figures_new/Figure_4/data/nk_fluctuate_quartile_comb2ref.pkl')

#%% 230209 add all combination
cor_df = pd.read_pickle('C:/github/LiverDeconv/_Figures_new/Figure_4/data/nk_fluctuate_quartile_comb2ref.pkl')
add_df = pd.DataFrame([0.629,('B','Basophil','CD4','CD8','Cholangiocyte','Eosinophil','Hepatocyte','Kupffer',
                                            'LSEC','Monocyte','NK','Neutrophil','Stellate')],index=cor_df.columns.tolist()).T
update_df = pd.concat([cor_df,add_df])
pd.to_pickle(update_df,'C:/github/LiverDeconv/_Figures_new/Figure_4/data/nk_fluctuate_quartile_comb2ref.pkl')
update_df.to_csv('C:/github/LiverDeconv/_Figures_new/Figure_4/data/nk_fluctuate_quartile_comb2ref.csv')
